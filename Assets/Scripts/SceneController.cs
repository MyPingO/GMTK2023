...
public class LevelLoadEventArgs : EventArgs
{
    ...
    public LevelLoadEventArgs(SceneIndexes level)
    {
        this.scene = level;
    }
}
...
public class SceneController : MonoBehaviour
{
    ...
    public void LoadTitleFromStart()
    {
        loadingScreen.ToggleScreen(true).onComplete += () =>
        {
            ...
            StartCoroutine(LoadAllProcess(() =>
            {
                ...
                OnLevelFinishedLoading?.Invoke(this, new LevelLoadEventArgs(SceneIndexes.TITLE));
            }));
        };
    }
    ...
    public void LoadGameFromTitle()
    {
        loadingScreen.ToggleScreen(true).onComplete += () =>
        {
            ...
            StartCoroutine(LoadAllProcess(() =>
            {
                ...
                OnLevelFinishedLoading?.Invoke(this, new LevelLoadEventArgs(SceneIndexes.LEVEL1));
    ...
    private IEnumerator GameCleanUp_LoadProcess(LoadProcess process)
    {
        ...
        yield return StartCoroutine(LevelController.instance.SceneExitCleanUp_Coroutine());
        yield return new WaitForSecondsRealtime(1f);
        process.Done();
    }
